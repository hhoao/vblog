...
(
    ...
    FOREIGN KEY (resource_id) REFERENCES ums_resource (`id`) ON UPDATE CASCADE ON DELETE RESTRICT,
    FOREIGN KEY (`role_id`) REFERENCES ums_role (`id`) ON UPDATE CASCADE ON DELETE RESTRICT
...
INSERT INTO `ams_catalog`(id, name, description, level, parent_id, sort, enable)
VALUES (4, '科技', '科技', 1, NULL, NULL, TRUE);
INSERT INTO `ams_catalog`(id, name, description, level, parent_id, sort, enable)
VALUES (5, '科技', '科技', 1, NULL, NULL, TRUE);
INSERT INTO `ams_catalog`(id, name, description, level, parent_id, sort, enable)
VALUES (6, '科技', '科技', 1, NULL, NULL, TRUE);
INSERT INTO `ams_catalog`(id, name, description, level, parent_id, sort, enable)
VALUES (7, '科技', '科技', 1, NULL, NULL, TRUE);
INSERT INTO `ams_catalog`(id, name, description, level, parent_id, sort, enable)
VALUES (8, '科技', '科技', 1, NULL, NULL, TRUE);
...
(
    ...
    PRIMARY KEY (`id`),
    FOREIGN KEY (`article_id`) REFERENCES `ams_article` (`id`) ON UPDATE CASCADE ON DELETE RESTRICT,
