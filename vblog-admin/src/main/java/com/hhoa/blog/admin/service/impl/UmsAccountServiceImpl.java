...
import com.hhoa.blog.admin.bean.UmsAccountWrapper;
import com.hhoa.blog.admin.bean.UmsLoginParam;
import com.hhoa.blog.admin.dao.UmsAccountDao;
...
public class UmsAccountServiceImpl implements UmsAccountService {
    ...
    public UmsAccountWrapper getAccountByAuthorization(String authorization) {
        String accountName = jwtTokenService.getSubjectFromAuthorization(authorization);
//        UmsAccountWrapper accountByAccountName = (UmsAccountWrapper) this.getAccountByAccountName(accountName);
