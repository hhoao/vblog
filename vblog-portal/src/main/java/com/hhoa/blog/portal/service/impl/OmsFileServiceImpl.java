...
import com.hhoa.blog.portal.dao.OmsFileDao;
...
public class OmsFileServiceImpl implements OmsFileService {
    ...
    public void download(String filesUUID, HttpServletResponse response) {
        try {
            ...
            response.addHeader("Content-Disposition", "attachment;filename=" + URLEncoder.encode(filesUUID, StandardCharsets.UTF_8));
